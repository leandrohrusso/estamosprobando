# [Snapshot] Andrej Karpathy Skills · EXAMPLES.md

> **Fuente original:** <https://github.com/forrestchang/andrej-karpathy-skills/blob/main/EXAMPLES.md>
> **SHA capturado:** 6c4283595e031f158870cd38e4e39d281332d621
> **Fecha snapshot:** 2026-05-07
> **Por qué está acá:** complemento operativo del [karpathy-claude-md.md](./karpathy-claude-md.md) · contiene **ejemplos código antes/después** por cada uno de los 4 principios (P4 Think Before Coding · P5 Simplicity First · P6 Surgical Changes · P7 Goal-Driven Execution) · material concreto para construir las **anti-rationalization tables (P9)** de los 4 archivos satélite ya codificados en `.claude/rules/<nombre>.md`. Descubierto durante validación empírica del repo 2026-05-07 (no estaba en snapshot original 2026-05-05). Repo verificado **estable** (último cambio core feb 2026 · commits posteriores son translations + Cursor support · cero churn riesgoso).
