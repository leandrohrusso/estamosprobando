# [Snapshot] Addy Osmani · agent-skills · README.md

> **Fuente original:** <https://github.com/addyosmani/agent-skills/blob/main/README.md>
> **SHA capturado:** d3361e4deb29ddde0b70ffa3c5160bc48d2c755b
> **Fecha snapshot:** 2026-05-05
> **Por qué está acá:** referencia consultable para codificación de principios. Origen de los principios **P8 (Skills con shape estándar)**, **P9 (Anti-rationalization tables)**, **P10 (Progressive disclosure)** del análisis fundacional del proyecto upstream. Documenta los 20 skills production-grade, las 6 fases SDLC (Define / Plan / Build / Verify / Review / Ship), las 3 personas paralelas (code-reviewer, security-auditor, test-engineer), los 7 slash commands, y el patrón fan-out paralelo en `/ship`.
> **NO modificar** — snapshot inmutable.
>
> **⚠️ Snapshot académico:** los links internos del README original apuntan a la estructura del repo `addyosmani/agent-skills` upstream (`docs/`, `skills/`, `agents/`, `references/`). Esos paths NO existen en el pack workflow-base · son citas del repo de Addy Osmani · seguilos en GitHub si querés explorar la implementación original.
